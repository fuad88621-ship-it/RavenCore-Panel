...
export const api = {
  ...
  writeFile: (id, path, content, encoding = 'utf8') => req(`/api/client/servers/${id}/files/write`, { method: 'POST', body: JSON.stringify({ path, content, encoding }) }),
  ...
  archiveFiles: (id, paths, archiveName) => req(`/api/client/servers/${id}/files/archive`, { method: 'POST', body: JSON.stringify({ paths, archiveName }) }),
  extractArchive: (id, path) => req(`/api/client/servers/${id}/files/extract`, { method: 'POST', body: JSON.stringify({ path }) }),
  ...
  downloadBackup: (id) => `${window.location.origin}/api/client/backups/${id}/download`,
  ...
  admin: {
    ...
    nodeHealth: () => req('/api/admin/nodes/health'),
    alerts: () => req('/api/admin/alerts'),
    ...
    transferProgress: (id) => req(`/api/admin/transfers/${id}`),
    ...
    createBackup: () => req('/api/admin/backup', { method: 'POST' }),
    listBackups: () => req('/api/admin/backup'),
    downloadBackup: (name) => `${window.location.origin}/api/admin/backup/download/${encodeURIComponent(name)}`,
